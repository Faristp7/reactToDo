  ...
  return (
    <div
      className={`flex justify-center items-center mt-10 md:mt-0 md:h-screen ${
        darkMode ? "bg-slate-900 text-white" : "md:bg-gradient-to-r from-indigo-100"
    ...
    >
      <div className="absolute right-5 top-5 hidden md:block ">
        <img
          ...
          className={`w-6 h-6 cursor-pointer transition-transform duration-300 ${darkMode ? "invert rotate-180" : ""}`}
        />
      </div>
        ...
        <div className="">
          <div className="flex">
            ...
            <img
              ...
              alt="Add"
              className={`w-5 h-5 cursor-pointer mt-2 ml-3 transition-invert ${darkMode ? "invert" : ""}`}
            />
          </div>
          {toDos.map((obj) => {
            return (
              <div className="flex mt-5 justify-between transition-opacity">
                ...
                <div>
                  <img
                    ...
                    alt="delete"
                    className={`w-5 h-5 cursor-pointer ml-3 ${darkMode ? "invert" : ''}`}
                  />
                </div>
              </div>
            );
